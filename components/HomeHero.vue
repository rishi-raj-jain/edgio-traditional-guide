  ...
  <main class="d-container">
    ...
    <div class="relative sm:overflow-hidden">
      ...
      <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
        ...
        <p class="mt-6 max-w-lg mx-auto text-center text-xl sm:max-w-3xl text-white">
          Plug-and-play image optimization for Nuxt apps. Resize and transform your images in your code using built-in optimizer or your favorite
          images CDN.
        </p>
        ...
        <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
          <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
            <nuxt-link
              ...
              class="flex items-center justify-center px-4 py-3 transition duration-300 hover:bg-primary-600 ring-white focus:ring-2 ring-offset-2 ring-offset-primary-800 border border-transparent text-base font-medium rounded-md shadow-sm bg-primary-500 sm:px-8 text-white"
            >
              Get started
            </nuxt-link>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="flex items-center justify-center font-medium px-4 py-3 transition duration-300 sm:px-8 rounded ring-white hover:ring-2 text-white"
            >
              Play online
            </a>
          </div>
