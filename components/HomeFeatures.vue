<template>
  <div class="d-container-content py-16 sm:pt-20 sm:pb-24 relative">
    <div class="grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
      <HomeFeature v-for="(feature, index) of features" :key="index" :feature="feature" />
    </div>
  </div>
</template>
